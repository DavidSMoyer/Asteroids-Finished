...
public class Rocket extends SmoothMover
{
    ...
    /**
     * Checks the keys for movement and attacks.
     * 
    ...
    private void fire()
    {
        ...
        {
            ((Space)getWorld()).addObject(bullet,getX(),getY());
            bullet.move();
            waveDelayCount = 0;
        }
    }
    ...
    private void startProtonWave()
    {
        ...
        {
            ((Space)getWorld()).addObject(wave,getX(),getY());
            waveDelayCount = 0;
        }
    }
    ...
    /**
     * Moves forward if the right key is pressed, at a quick pace. Also changes the image to match.
     * 
     * @param None There are no parameters.
     * @return Returns nothing.
     */
     ...
     *          that is initialized to get one intersectinf (intersecting*) object of
     *          class Asteroid
     *          
    ...
    /**
     * Checks to see if it is touching an asteroid. If it is, blow up and end the game.
     * 
     * @param None There are no parameters.
     * @return Returns nothing.
     */
